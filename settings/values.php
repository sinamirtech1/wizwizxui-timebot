...
$mainValues = [
    ...
    'customer_custome_plan_name'=>'اسم کانفیگ رو وارد کن ( فقط حروف انگیلیسی کوچک به همراه عدد )
    برای مثال: ali1',
...
",
    ...
    'start_message'=>'سلام به ربات سینامیرتک خیلی خوش اومدی 🫡
...
مدت زمان سرویس: DAYS روز',
    ...
    'incorrect_config_name'=>"😡|اسم معتبر نیست. فقط حروف انگلیسی (کوچک/بزرگ)، عدد، _ و - مجازه (۳ تا ۳۲ کاراکتر)",
